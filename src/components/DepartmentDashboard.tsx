            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">
                  {currentDepartment ? departmentNames[currentDepartment] : 'Department'}
                </h1>
                <p className="text-xs text-gray-500">Specialized Care & Treatment</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl border shadow-sm p-3">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-semibold text-slate-900 text-sm">Department Overview</h2>
                </div>
            ...
            <div className="bg-white rounded-xl border shadow-sm p-3 flex-grow overflow-y-auto">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-semibold text-slate-900 text-sm">Department Guidelines</h2>
                </div>
              </div>
              
              <div className="space-y-2">
                <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                  <h3 className="text-xs font-medium text-slate-700 mb-1.5">Department Protocols</h3>
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Treatment Guidelines</span>
                      <span className="text-blue-600">View Protocol</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Follow-up Procedures</span>
                      <span className="text-blue-600">View Protocol</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                  <h3 className="text-xs font-medium text-slate-700 mb-1.5">Common Procedures</h3>
                  <div className="space-y-1">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Procedure 1</span>
                      <span className="text-blue-600">View Guidelines</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Procedure 2</span>
                      <span className="text-blue-600">View Guidelines</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Procedure 3</span>
                      <span className="text-blue-600">View Guidelines</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                  <h3 className="text-xs font-medium text-slate-700 mb-1.5">Department Resources</h3>
                  <div className="space-y-1">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Equipment List</span>
                      <span className="text-blue-600">View List</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Staff Schedule</span>
                      <span className="text-blue-600">View Schedule</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-600">Contact Information</span>
                      <span className="text-blue-600">View Contacts</span>
                    </div>
                  </div>
                </div>
              </div>
